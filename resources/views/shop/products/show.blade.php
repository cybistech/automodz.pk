        ...
        <div>
            <div class="card overflow-hidden">
                @if($product->primary_image)
                    <img src="{{ asset('storage/'.$product->primary_image) }}" alt="{{ $product->name }}" width="800" height="800" fetchpriority="high" decoding="async" class="aspect-square w-full object-cover">
                @else
            ...
            @if($product->images && count($product->images) > 1)
                <div class="mt-4 grid grid-cols-4 gap-3">
                    @foreach($product->images as $image)
                        <img src="{{ asset('storage/'.$image) }}" alt="" width="200" height="200" loading="lazy" decoding="async" class="aspect-square rounded-lg border border-slate-700 object-cover">
                    @endforeach
                </div>
            @endif
                ...
                <div class="card mt-6 overflow-hidden p-4">
                    ...
                    @else
                        ...
                        <div class="aspect-video overflow-hidden rounded-lg">
                            <iframe src="{{ $embedUrl }}" class="h-full w-full" loading="lazy" title="Product video" allowfullscreen></iframe>
                        </div>
                    @endif
                </div>
            @endif
